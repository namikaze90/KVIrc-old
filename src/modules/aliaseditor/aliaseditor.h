...
public:
	...
	void exportSelectionInSinglesFiles(QList<KviAliasListViewItem*> *l);
...
//	QString const & findWord(const QString &txt,bool);
	...
	void appendSelectedItems(QList<KviAliasEditorListViewItem*> * l,KviAliasEditorListViewItem * pStartFrom,bool bIncludeChildrenOfSelected = false);
	void appendAliasItems(QList<KviAliasListViewItem*> * l,KviAliasEditorListViewItem * pStartFrom,bool bSelectedOnly);
	void appendNamespaceItems(QList<KviAliasListViewItem*> * l,KviAliasEditorListViewItem * pStartFrom,bool bSelectedOnly);
