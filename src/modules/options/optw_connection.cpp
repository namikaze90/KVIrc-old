...
{
	createLayout(2,1);
	QGroupBox *gbox = addGroupBox(0,0,0,0,__tr2qs_ctx("On Disconnect","options"));
	...
	gbox = addGroupBox(0,1,0,1,__tr2qs_ctx("On Unexpected Disconnect","options"));
...
: KviOptionsWidget(parent,"ssl_options_widget")
{
	...
	QGroupBox * gbox = addGroupBox(0,0,0,0,__tr2qs_ctx("Certificate","options"));
	...
	gbox = addGroupBox(0,1,0,1,__tr2qs_ctx("Private Key","options"));
...
: KviOptionsWidget(parent,"transport_options_widget")
{
	...
	QGroupBox * g = addGroupBox(0,0,0,0,__tr2qs_ctx("Timeout Values","options"),this);
	...
	g = addGroupBox(0,3,0,3,__tr2qs_ctx("Network Interfaces","options"));
...
: KviOptionsWidget(parent,"ident_options_widget")
{
	...
	QGroupBox * gbox = addGroupBox(0,1,0,1,__tr2qs_ctx("Output verosity","options"),KVI_OPTION_BOOL(KviOption_boolUseIdentService));
	...
	gbox = addGroupBox(0,2,0,2,__tr2qs_ctx("Configuration","options"),KVI_OPTION_BOOL(KviOption_boolUseIdentService));
	...
	gbox = addGroupBox(0,3,0,3,__tr2qs_ctx("IPv6 Settings","options"),KVI_OPTION_BOOL(KviOption_boolUseIdentService));
