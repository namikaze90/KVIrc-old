...
: KviOptionsWidget(parent,"sound_system_options_widget")
{
	...
	createLayout(3,1);
#endif
	QGroupBox * g = addGroupBox(0,0,0,0,__tr2qs_ctx("Sound System","options"),true);
	...
	g = addGroupBox(0,1,0,1,__tr2qs_ctx("Media Player","options"),true);
	...
	g = addGroupBox(0,2,0,2,__tr2qs_ctx("ID3 tags' encoding","options"),true);
...
#ifdef COMPILE_ON_WINDOWS
	g = addGroupBox(0,3,0,3,__tr2qs_ctx("Winamp messages ecoding","options"),true);
