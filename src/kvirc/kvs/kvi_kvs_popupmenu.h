...
public:
	...
	~KviKvsPopupMenu();
protected:
	QList<KviKvsPopupMenuItem*>  * m_pItemList;
private:
	QString                            m_szName;
	KviKvsPopupMenu                  * m_pParentPopup;
	QList<KviKvsScript*>         * m_pPrologues;
	QList<KviKvsScript*>         * m_pEpilogues;
...
public:
	...
	QList<KviKvsScript*> * epilogues(){ return m_pEpilogues; };
	QList<KviKvsScript*> * prologues(){ return m_pPrologues; };
