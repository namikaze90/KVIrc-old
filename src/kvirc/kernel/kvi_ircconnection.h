...
private:
	...
	QList<KviChannel*>                   * m_pChannelList;          // owned, never null, elements shallow
	QList<KviQuery*>                     * m_pQueryList;            // owned, never null, elements shallow
...
public:
	...
	QList<KviChannel*> * channelList(){ return m_pChannelList; };
...
public:
	...
	QList<KviQuery*> * queryList(){ return m_pQueryList; };
