...
protected:
	...
	QHash<QString,KviCustomToolBarDescriptor*> * m_pDescriptors;
public:
	...
	QHash<QString,KviCustomToolBarDescriptor*> * descriptors(){ return m_pDescriptors; };
	KviCustomToolBar * firstExistingToolBar();
	KviCustomToolBarDescriptor * create(const QString &szId,const QString &szLabelCode);
	KviCustomToolBarDescriptor * find(const QString &szId){ return m_pDescriptors->value(szId); };
