...
public:
	...
	~KviIrcUserDataBase();
private:
	QHash<QString,KviIrcUserEntry*> * m_pDict;
public:
	void clear();
	KviIrcUserEntry * insertUser(const QString &nick,const QString &user,const QString &hostname);
	KviIrcUserEntry * find(const QString &nick){ return m_pDict->value(nick); };
	void removeUser(const QString &nick,KviIrcUserEntry * e);
	QHash<QString,KviIrcUserEntry*> * dict(){ return m_pDict; };
