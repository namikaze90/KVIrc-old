...
public:
	...
	QString property(const QString& name){ return m_pPropertyDict->value(name); };
	// val must be allocated with NEW!
	void setProperty(const QString& name,const QString& val){ m_pPropertyDict->insert(name,val); };
